...
FontDef Font_5x7 = {5, 7, 32, 127, FONT_FLAG_VERT, 0, 3, 0x3, (1<<6), (const uint16_t*)font_5x7};
#endif

#ifdef LCDFONT_INCLUDE_FONT_6x8
FontDef Font_6x8 = {6, 8, 1, 148, FONT_FLAG_VERT|FONT_FLAG_BTAB, 0, 3, 0x6, (1<<7), (const uint16_t*)font_6x8};
#endif

#ifdef LCDFONT_INCLUDE_FONT_6x12
FontDef Font_6x12 = {6, 12, 32, 126, 0, 0, 2, 0x10, (1<<5), (const uint16_t*)Font6x12};
#endif

#ifdef LCDFONT_INCLUDE_FONT_7x10
FontDef Font_7x10 = {7, 10, 32, 126, 0, 0, 2, 0x18, (1<<6), (const uint16_t*)Font7x10};
#endif

#ifdef LCDFONT_INCLUDE_FONT_8x8
FontDef Font_8x8 = {8, 8, 32, 127, 0, 0, 3, 0x30, (1<<7), (const uint16_t*)Font8x8};
#endif

#ifdef LCDFONT_INCLUDE_FONT_8x16
FontDef Font_8x16 = {8, 16, 32, 127, 0, 0, 4, 0xf0, (1<<7), (const uint16_t*)font_8x16};
#endif
