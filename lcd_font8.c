...
#ifdef LCDFONT_INCLUDE_FONT_5x7 /* total size 480 */
static const uint8_t font_5x7 [] = { //5byte (W) *7bit (H) (FONT_FLAG_VERT)
    ...
    0x02,0x15,0x15,0x0f,0x01,/*a*/
    0x7f,0x0a,0x11,0x11,0x0e,/*b*/
    0x0e,0x11,0x11,0x11,0x0a,/*c*/
    0x0e,0x11,0x11,0x0a,0x7f,/*d*/
    0x0e,0x15,0x15,0x15,0x0c,/*e*/
    0x00,0x08,0x3f,0x48,0x20,/*f*/
    0x0c,0x12,0x12,0x1c,0x0f,/*g*/
...
#ifdef LCDFONT_INCLUDE_FONT_8x8
//from https://github.com/dhepper/font8x8/tree/master
...
static const uint8_t Font7x10 [] = { //7bit (W) * 10byte (H)
...
#ifdef LCDFONT_INCLUDE_FONT_6x12 // total size 1140
static const uint8_t Font6x12 [] = { //6bit(width)x12(height)
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,/* */
    0x00,0x08,0x08,0x08,0x08,0x08,0x00,0x00,0x08,0x00,0x00,0x0a,/*!*/
    0x0a,0x14,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,/*"*/
    0x00,0x14,0x14,0x3e,0x14,0x14,0x3e,0x14,0x14,0x00,0x00,0x00,/*#*/
    0x08,0x1c,0x2a,0x28,0x18,0x0c,0x0a,0x2a,0x1c,0x08,0x00,0x00,/*$*/
    0x00,0x12,0x2a,0x2c,0x2a,0x1d,0x0d,0x15,0x12,0x00,0x00,0x00,/*%*/
    0x00,0x08,0x14,0x14,0x1b,0x2a,0x2a,0x25,0x1a,0x00,0x00,0x10,/*&*/
    0x10,0x20,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x02,/*'*/
    0x04,0x04,0x08,0x08,0x08,0x08,0x08,0x04,0x04,0x02,0x00,0x10,/*(*/
    ...
    0x00,0x1c,0x22,0x22,0x22,0x22,0x22,0x22,0x1c,0x00,0x00,0x00,/*0*/
    0x00,0x08,0x18,0x08,0x08,0x08,0x08,0x08,0x1c,0x00,0x00,0x00,/*1*/
    0x00,0x1c,0x22,0x22,0x04,0x08,0x10,0x20,0x3e,0x00,0x00,0x00,/*2*/
    0x00,0x1c,0x22,0x02,0x0c,0x02,0x02,0x22,0x1c,0x00,0x00,0x00,/*3*/
    0x00,0x04,0x0c,0x0c,0x14,0x24,0x3e,0x04,0x0e,0x00,0x00,0x00,/*4*/
    0x00,0x3e,0x20,0x20,0x3c,0x22,0x02,0x22,0x1c,0x00,0x00,0x00,/*5*/
    0x00,0x0c,0x12,0x20,0x2c,0x32,0x22,0x22,0x1c,0x00,0x00,0x00,/*6*/
    0x00,0x1e,0x02,0x04,0x04,0x08,0x08,0x08,0x08,0x00,0x00,0x00,/*7*/
    0x00,0x1c,0x22,0x22,0x1c,0x22,0x22,0x22,0x1c,0x00,0x00,0x00,/*8*/
    0x00,0x1c,0x22,0x22,0x26,0x1a,0x02,0x24,0x18,0x00,0x00,0x00,/*9*/
    ...
    0x00,0x1c,0x22,0x22,0x04,0x08,0x08,0x00,0x08,0x00,0x00,0x00,/*?*/
    0x00,0x0e,0x11,0x25,0x2d,0x2d,0x2e,0x11,0x0e,0x00,0x00,0x00,/*@*/
    0x00,0x08,0x08,0x0c,0x14,0x14,0x1e,0x12,0x33,0x00,0x00,0x00,/*A*/
    0x00,0x3c,0x12,0x12,0x1c,0x12,0x12,0x12,0x3c,0x00,0x00,0x00,/*B*/
    0x00,0x1e,0x22,0x20,0x20,0x20,0x20,0x22,0x1c,0x00,0x00,0x00,/*C*/
    0x00,0x3c,0x12,0x12,0x12,0x12,0x12,0x12,0x3c,0x00,0x00,0x00,/*D*/
    0x00,0x3e,0x12,0x14,0x1c,0x14,0x10,0x12,0x3e,0x00,0x00,0x00,/*E*/
    0x00,0x3e,0x12,0x14,0x1c,0x14,0x10,0x10,0x38,0x00,0x00,0x00,/*F*/
    0x00,0x0e,0x12,0x20,0x20,0x27,0x22,0x12,0x0c,0x00,0x00,0x00,/*G*/
    0x00,0x33,0x12,0x12,0x1e,0x12,0x12,0x12,0x33,0x00,0x00,0x00,/*H*/
    0x00,0x3e,0x08,0x08,0x08,0x08,0x08,0x08,0x3e,0x00,0x00,0x00,/*I*/
    0x00,0x1f,0x04,0x04,0x04,0x04,0x04,0x04,0x04,0x24,0x38,0x00,/*J*/
    0x00,0x3b,0x12,0x14,0x18,0x14,0x12,0x12,0x3b,0x00,0x00,0x00,/*K*/
    0x00,0x38,0x10,0x10,0x10,0x10,0x10,0x11,0x3f,0x00,0x00,0x00,/*L*/
    0x00,0x37,0x36,0x36,0x36,0x2a,0x2a,0x2a,0x2b,0x00,0x00,0x00,/*M*/
    0x00,0x37,0x12,0x1a,0x1a,0x16,0x16,0x12,0x3a,0x00,0x00,0x00,/*N*/
    0x00,0x1c,0x22,0x22,0x22,0x22,0x22,0x22,0x1c,0x00,0x00,0x00,/*O*/
    0x00,0x3c,0x12,0x12,0x1c,0x10,0x10,0x10,0x38,0x00,0x00,0x00,/*P*/
    0x00,0x1c,0x22,0x22,0x22,0x22,0x3a,0x26,0x1c,0x06,0x00,0x00,/*Q*/
    0x00,0x3c,0x12,0x12,0x1c,0x14,0x12,0x12,0x3b,0x00,0x00,0x00,/*R*/
    0x00,0x1e,0x22,0x20,0x18,0x04,0x02,0x22,0x3c,0x00,0x00,0x00,/*S*/
    0x00,0x3e,0x2a,0x08,0x08,0x08,0x08,0x08,0x1c,0x00,0x00,0x00,/*T*/
    0x00,0x33,0x12,0x12,0x12,0x12,0x12,0x12,0x0c,0x00,0x00,0x00,/*U*/
    0x00,0x33,0x12,0x12,0x14,0x14,0x0c,0x08,0x08,0x00,0x00,0x00,/*V*/
    0x00,0x2a,0x2a,0x2a,0x2a,0x1c,0x14,0x14,0x14,0x00,0x00,0x00,/*W*/
    0x00,0x36,0x14,0x14,0x08,0x08,0x14,0x14,0x36,0x00,0x00,0x00,/*X*/
    0x00,0x36,0x14,0x14,0x14,0x08,0x08,0x08,0x1c,0x00,0x00,0x00,/*Y*/
    0x00,0x3e,0x24,0x04,0x08,0x08,0x10,0x12,0x3e,0x00,0x00,0x0e,/*Z*/
    0x08,0x08,0x08,0x08,0x08,0x08,0x08,0x08,0x08,0x0e,0x00,0x00,/*[*/
    0x10,0x10,0x08,0x08,0x08,0x04,0x04,0x04,0x02,0x02,0x00,0x1c,/*\*/
    0x04,0x04,0x04,0x04,0x04,0x04,0x04,0x04,0x04,0x1c,0x00,0x08,/*]*/
    0x14,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,/*^*/
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x3f,0x10,/*_*/
    0x08,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,/*`*/
    0x00,0x00,0x00,0x00,0x0c,0x12,0x0e,0x12,0x0f,0x00,0x00,0x00,/*a*/
    0x30,0x10,0x10,0x10,0x1c,0x12,0x12,0x12,0x1c,0x00,0x00,0x00,/*b*/
    0x00,0x00,0x00,0x00,0x0e,0x12,0x10,0x12,0x0c,0x00,0x00,0x00,/*c*/
    0x06,0x02,0x02,0x02,0x0e,0x12,0x12,0x12,0x0f,0x00,0x00,0x00,/*d*/
    0x00,0x00,0x00,0x00,0x0c,0x12,0x1e,0x10,0x0e,0x00,0x00,0x00,/*e*/
    0x06,0x09,0x08,0x08,0x1e,0x08,0x08,0x08,0x1e,0x00,0x00,0x00,/*f*/
    0x00,0x00,0x00,0x00,0x0f,0x12,0x0c,0x10,0x0e,0x11,0x0e,0x00,/*g*/
    0x30,0x10,0x10,0x10,0x1c,0x12,0x12,0x12,0x3b,0x00,0x00,0x00,/*h*/
    0x08,0x08,0x00,0x00,0x18,0x08,0x08,0x08,0x1c,0x00,0x00,0x00,/*i*/
    0x04,0x04,0x00,0x00,0x0c,0x04,0x04,0x04,0x04,0x04,0x38,0x00,/*j*/
    0x30,0x10,0x10,0x10,0x16,0x14,0x18,0x14,0x32,0x00,0x00,0x00,/*k*/
    0x38,0x08,0x08,0x08,0x08,0x08,0x08,0x08,0x3e,0x00,0x00,0x00,/*l*/
    0x00,0x00,0x00,0x00,0x3c,0x2a,0x2a,0x2a,0x2a,0x00,0x00,0x00,/*m*/
    0x00,0x00,0x00,0x00,0x3c,0x12,0x12,0x12,0x3b,0x00,0x00,0x00,/*n*/
    0x00,0x00,0x00,0x00,0x0c,0x12,0x12,0x12,0x0c,0x00,0x00,0x00,/*o*/
    0x00,0x00,0x00,0x00,0x3c,0x12,0x12,0x12,0x1c,0x10,0x38,0x00,/*p*/
    0x00,0x00,0x00,0x00,0x0e,0x12,0x12,0x12,0x0e,0x02,0x07,0x00,/*q*/
    0x00,0x00,0x00,0x00,0x36,0x18,0x10,0x10,0x38,0x00,0x00,0x00,/*r*/
    0x00,0x00,0x00,0x00,0x1e,0x10,0x0c,0x02,0x1e,0x00,0x00,0x00,/*s*/
    0x00,0x00,0x08,0x08,0x1e,0x08,0x08,0x08,0x0e,0x00,0x00,0x00,/*t*/
    0x00,0x00,0x00,0x00,0x36,0x12,0x12,0x12,0x0f,0x00,0x00,0x00,/*u*/
    0x00,0x00,0x00,0x00,0x36,0x14,0x14,0x08,0x08,0x00,0x00,0x00,/*v*/
    0x00,0x00,0x00,0x00,0x2a,0x2a,0x1c,0x14,0x14,0x00,0x00,0x00,/*w*/
    0x00,0x00,0x00,0x00,0x36,0x14,0x08,0x14,0x36,0x00,0x00,0x00,/*x*/
    0x00,0x00,0x00,0x00,0x33,0x12,0x12,0x0c,0x04,0x08,0x30,0x00,/*y*/
    0x00,0x00,0x00,0x00,0x1e,0x04,0x08,0x08,0x1e,0x00,0x00,0x06,/*z*/
    0x04,0x04,0x04,0x04,0x0c,0x04,0x04,0x04,0x04,0x06,0x00,0x04,/*{*/
    0x04,0x04,0x04,0x04,0x04,0x04,0x04,0x04,0x04,0x04,0x04,0x18,/*|*/
    0x08,0x08,0x08,0x08,0x04,0x08,0x08,0x08,0x08,0x18,0x00,0x1a,/*}*/
    0x24,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x3d,/*~*/
};
#endif

#ifdef LCDFONT_INCLUDE_FONT_8x12N
static const uint8_t font_8x12N [] = { // 8bit (W) * 12byte (H)
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x60,0x60,0x00, /*.*/
    0x02,0x02,0x04,0x04,0x08,0x08,0x10,0x10,0x20,0x20,0x40,0x00, /*/*/
    0x18,0x24,0x42,0x42,0x42,0x42,0x42,0x42,0x42,0x24,0x18,0x00, /*0*/
    0x10,0x70,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x7c,0x00, /*1*/
    0x3c,0x42,0x42,0x42,0x04,0x04,0x08,0x10,0x20,0x42,0x7e,0x00, /*2*/
    0x3c,0x42,0x42,0x04,0x18,0x04,0x02,0x02,0x42,0x44,0x38,0x00, /*3*/
    0x04,0x0c,0x14,0x24,0x24,0x44,0x44,0x7e,0x04,0x04,0x1e,0x00, /*4*/
    0x7e,0x40,0x40,0x40,0x58,0x64,0x02,0x02,0x42,0x44,0x38,0x00, /*5*/
    0x1c,0x24,0x40,0x40,0x58,0x64,0x42,0x42,0x42,0x24,0x18,0x00, /*6*/
    0x7e,0x44,0x44,0x08,0x08,0x10,0x10,0x10,0x10,0x10,0x10,0x00, /*7*/
    0x3c,0x42,0x42,0x42,0x24,0x18,0x24,0x42,0x42,0x42,0x3c,0x00, /*8*/
    0x18,0x24,0x42,0x42,0x42,0x26,0x1a,0x02,0x02,0x24,0x38,0x00, /*9*/
};
#endif

#ifdef LCDFONT_INCLUDE_FONT_8x16
static const uint8_t font_8x16 [] = { // 8bit (W) * 16byte (H)
...
#ifdef LCDFONT_INCLUDE_FONT_5x7 //5x8...
const FontDef Font_5x7 = {5, 7, 32, 127, FONT_FLAG_VERT, 0, 3, 0x3, (1<<6), (const uint16_t*)font_5x7};
#endif

#ifdef LCDFONT_INCLUDE_FONT_6x8
const FontDef Font_6x8 = {6, 8, 1, 148, FONT_FLAG_VERT|FONT_FLAG_BTAB, 0, 3, 0x38, (1<<7), (const uint16_t*)font_6x8};
#endif

#ifdef LCDFONT_INCLUDE_FONT_6x12
const FontDef Font_6x12 = {6, 12, 32, 126, 0, 0, 2, 0x10, (1<<5), (const uint16_t*)Font6x12};
#endif

#ifdef LCDFONT_INCLUDE_FONT_7x10
const FontDef Font_7x10 = {7, 10, 32, 126, 0, 0, 2, 0x18, (1<<6), (const uint16_t*)Font7x10};
#endif

#ifdef LCDFONT_INCLUDE_FONT_8x8
const FontDef Font_8x8 = {8, 8, 32, 127, 0, 0, 3, 0x30, (1<<7), (const uint16_t*)Font8x8};
#endif

#ifdef LCDFONT_INCLUDE_FONT_8x12N
const FontDef Font_8x12N = {8, 12, 46, 58, 0, 0, 3, 0x70, (1<<7), (const uint16_t*)font_8x12N};
#endif

#ifdef LCDFONT_INCLUDE_FONT_8x16
const FontDef Font_8x16 = {8, 16, 32, 127, 0, 0, 3, 0x70, (1<<7), (const uint16_t*)font_8x16};
#endif
